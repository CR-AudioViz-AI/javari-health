// app/api/generate/route.ts — javari-health
...
const CREDIT_COST      = 3
const SYSTEM           = `You are a health information specialist. Provide evidence-based health information, wellness guides, symptom information, and preventive care tips. Always note: not medical advice, consult a doctor.`
const ACTIONS          = ["wellness_guide", "symptom_information", "nutrition_info", "mental_health_resources", "preventive_care", "medication_information"]
